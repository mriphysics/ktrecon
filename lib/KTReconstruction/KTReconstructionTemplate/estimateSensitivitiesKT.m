function S=estimateSensitivitiesKT(y,x,B,voxsiz,lr)

%ESTIMATESENSITIVITIESKT   Estimate sensitivities by ESPIRIT
%   S=ESTIMATESENSITIVITIESKT(Y,{X},{B},{VOXSIZ},{LR})  
...
if lr
    ...
    rec.Alg.parE.Ksph=round(400^(2/3));%Number of points for spherical calibration area, unless 0, it overrides other K's
end
